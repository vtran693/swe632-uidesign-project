<div id='class-details-SWE645'>
	<div class="panel-group" id="accordion">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h4 class="panel-title">
					<a href="#collapseOne">SWE 645 - Component Based Software Development</a>
				</h4>
			</div>
				...
				<div class="panel-body">
					...
					<div class='tableauPlaceholder' style='width: 1000px; height: 827px;'>
						<object class='tableauViz' width='1000' height='827' style='display:none;'>
							...
							<param name='name' value='NuthanaDashboards&#47;645Dashboard' />
					...
					<div class="col-md-12">
						<div class="col-md-3">
							<button type="button" id="viet-swe645-close-details-button" class="btn btn-primary" onclick="hideSWE645Details()"> Close Details Panel </button>
						</div>
					</div>
				</div>
			</div>
