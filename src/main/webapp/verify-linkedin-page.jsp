<div class="col-sm-2 col-sm-offset-4 frame">
    <div></div>
    <div class="profile">
        <img class="img-circle img-thumbnail" src="${pageContext.request.contextPath}/img/viet-linkedin-pic.jpg" />
    </div>
    <div>
        <div>
            <h4>Viet Tran</h4>
            <p>Mid-level Digital Solutions Developer</p>
            <p>Booz Allen Hamilton   George Mason University</p>
        </div>                
        <div>
            <div class="column">
                <p>15</p>
